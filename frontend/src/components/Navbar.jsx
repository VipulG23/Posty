    ...
    <div className="flex items-center justify-between mx-3 h-16">
      <div className="flex items-center gap-10">
        <div className="flex items-center gap-2">
          ...
          <img
            className="w-8"
            src="https://cdn.pixabay.com/photo/2017/11/10/05/42/email-2935508_640.png"
            alt="logo"
          />
          <h1 className="text-2xl text-gray-500 font-medium">Posty</h1>
        </div>
      </div>
      {user && (
        <>
          <div className="w-[-200%] mr-60">
